...
1. Open the [AudioPhile release page](https://github.com/anntropea-oss/audiophile/releases/latest) and expand **Assets** (click the small triangle if it’s collapsed).
